...
func (r *OpenStackVMSet) ValidateCreate() error {
	...
	// validate disks
	//
	if err := validateDisks(r.Spec.AdditionalDisks, []OpenStackVMSetAdditionalDisk{}); err != nil {
		return err
	}
...
func (r *OpenStackVMSet) ValidateUpdate(old runtime.Object) error {
	...
	// validate rootdisk
	//
	if err := validateRootDisk(r.Spec, OpenStackVMSetSpec{}); err != nil {
		return err
	}
	...
	// validate disks
	//
	if err := validateDisks(r.Spec.AdditionalDisks, oldInstance.Spec.AdditionalDisks); err != nil {
		return err
	}
