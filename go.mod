...
require (
	...
	github.com/nmstate/kubernetes-nmstate/api v0.0.0-20231019125903-c153c6a82fe0
...
replace (
	...
	github.com/k8snetworkplumbingwg/sriov-network-operator => github.com/openshift/sriov-network-operator v0.0.0-20230901020142-80616020d4bc // release-4.12
	...
	github.com/metal3-io/baremetal-operator/apis => github.com/openshift/baremetal-operator/apis v0.0.0-20230420090642-2bc268d1205a // release-4.12
	github.com/metal3-io/baremetal-operator/pkg/hardwareutils => github.com/openshift/baremetal-operator/pkg/hardwareutils v0.0.0-20220510141243-d7e915809852 // release-4.12
	...
	// controller runtime
	github.com/openshift/api => github.com/openshift/api v0.0.0-20230928134114-673ed0cfc7f1 // release-4.12
	github.com/openshift/client-go => github.com/openshift/client-go v0.0.0-20221019143426-16aed247da5c // release-4.12
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20231018221331-685ca0e1db69 // release-4.12
	...
	k8s.io/apimachinery => k8s.io/apimachinery v0.26.0-alpha.0.0.20231013002525-fdcfc2723dc8 // CVE-2023-44487
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20231013035233-ba592e4ccd41 // CVE-2023-44487
	...
	// kubevirt
	kubevirt.io/api => kubevirt.io/api v0.55.0
